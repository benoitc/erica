...
from couchapp.restkit.filters.basicauth import BasicAuth
from couchapp.restkit.filters.oauth2 import OAuthFilter
from couchapp.restkit.filters.simpleproxy import SimpleProxy
